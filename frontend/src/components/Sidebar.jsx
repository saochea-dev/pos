      ...
      {auth.isLoggedIn && (
        <>
          <div
            className={`flex-2 ${
              auth.open ? 'w-56' : 'w-12'
            } bg-[#222] scrollbar h-[100vh] relative duration-200 shadow-lg font-bold overflow-auto`}
            id="sidebar">
              ...
              <li id="sidenavEx1">
                ...
                {auth.open && (
                  <ul
                    ...
                    {auth.isAdmin && <Link to="/product-brands">
                      <li className="relative flex items-center text-[12px] py-[18px] h-6 overflow-hidden text-ellipsis whitespace-nowrap rounded hover:bg-[#111] transition duration-300 ease-in-out">
                        <span className="pl-6">
                          <RxDot size={20} />
                        </span>
                  ...
                  {auth.open && (
                    <ul
                      ...
                      <Link to={'/sale-reports'}>
                        <li className="cursor-pointer relative flex items-center text-[12px] py-[18px] h-6 overflow-hidden text-ellipsis whitespace-nowrap rounded hover:bg-[#111] transition duration-300 ease-in-out">
                          <span className="pl-6">
                            <RxDot size={20} />
                          </span>
                          <span
                ...
                {auth.open && (
                  <ul
                    ...
                    {auth.isAdmin && (
                      <>
                        <Popconfirm
                          ...
                          <li
                            className="relative flex items-center text-[12px] py-[18px] h-6 overflow-hidden text-ellipsis whitespace-nowrap rounded hover:bg-[#111] transition duration-300 ease-in-out cursor-pointer"
                            ...
                            <span
                              ...
                              // data-mdb-ripple="true"
                              data-mdb-ripple-color="dark">
                              <button className="outline-none text-white p-0 border-none font-bold button">
                                ទិន្នន័យបម្រុងទុក
                              </button>
                            </span>
                          </li>
                    ...
                    <Popconfirm
                      ...
                      <li
                        className="relative flex items-center text-[14px] py-[18px] h-6 overflow-hidden text-ellipsis whitespace-nowrap rounded hover:bg-[#111] transition duration-300 ease-in-out cursor-pointer"
                        onClick={showPopLogout}>
                        <span className="pl-6">
              ...
              <div className="flex items-center justify-center bg-grey-lighter mt-8 mb-8">
                <label className="w-64 flex flex-col items-center px-4 py-6 bg-white text-blue rounded-lg tracking-wide uppercase border border-blue cursor-pointer">
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      setFileName(
                        `${e.target.files[0].name} Size: ${e.target.files[0].size}kb`
                      );
                      setdbBackup((prev) => ({
                        ...prev,
