...
const Navbar = () => {
  ...
  // handle when user modify somthing
  ...
  const { data, isLoading } = useQuery(['user', accountModal], fetchUserById);
  ...
  useEffect(() => {
    if (!outstock.isLoading) {
      setOutStock(outstock.data);
    }
  }, [outstock.data]);
            ...
            <div className="container-fluid w-full flex flex-wrap items-center justify-between px-6">
              ...
              "
                    ...
                    <span className="text-white bg-red-700 absolute rounded-full text-xs -mt-2.5 ml-2 py-0 px-1.5">
                      {
                        (nNotification.current =
                          reorder.length + outStock.length)
                      }
                    </span>
                  </a>
                  {/* end of notification  */}
                ...
                <div className="dropdown relative">
                  <a
                    ...
                    <span className="text-gray-500 hover:text-gray-700 focus:text-gray-700">
                      {auth.username}
                    </span>
                  </a>
                  <ul
            ...
            <div className="offcanvas-body flex-grow py-4 px-[6px] overflow-y-auto">
              {reorder &&
                reorder.map((item, index) => (
                  <div
                    className="flex items-center w-full bg-[#ddd] p-2 h-22 my-1 rounded-sm relative"
                    key={index + 1}>
                    ...
                    <div className="flex text-sm h-22 w-52 flex-col ml-3">
                      <h3 className="font-bold">
                        កូដ:<span className="text-sm">{item.product_code}</span>
                      </h3>
                      ...
                      <p className="text-xs">
                        ផលិតផលរបស់អ្នកជិតអស់ពីស្តុកហើយ...
                      </p>
                    </div>
                    <span className="absolute top-2 right-4 text-lg text-red-400 opacity-0 font-semibold">
                      x
                    </span>
                  </div>
                ))}
                ...
                outStock.map((item, index) => (
                  <div
                    ...
                    <div className="flex text-sm h-22 w-52 flex-col ml-3">
                      ...
                      <p className="text-xs">ផលិតផលរបស់អ្នកអស់ពីស្តុកហើយ...</p>
                    </div>
