    ...
    <>
      <div className="flex-1 h-screen overflow-auto bg-gray-100">
        ...
        <div className="p-5">
          ...
          <h2 className="text-left py-2">សូម! បំពេញពត៍មានខាងក្រោម</h2>
          <div className="shadow bg-white rounded-sm">
            <div className="flex justify-around mt-4">
              ...
              <div className="flex-col mt-6">
                <div className="mb-7 xl:w-96">
                  <label
                    ...
                    ប្រភេទផលិតផល<span className="text-red-500 font-bold">*</span>
                  </label>
                  <select
                ...
                <div className="mb-7 xl:w-96">
                  <label
                    htmlFor="ProductUnit"
                    className="form-label inline-block mb-2 text-gray-700">
                    ឯកតាផលិតផល<span className="text-red-500 font-bold">*</span>
                  </label>
                  <select
                    className="form-select appearance-none
                                    block
              ...
              <div className="flex-col mt-6">
                <div className="mb-7 xl:w-96">
                  <label className="form-label inline-block text-gray-700 mb-2">
                    តម្លៃដើម<span className="text-red-500 font-bold">*</span>
                  </label>
                  <input
                ...
                <div className="mb-7 xl:w-96">
                  <label
                    htmlFor="outPrice"
                    className="form-label inline-block mb-2 text-gray-700">
                    តម្លៃលក់ចេញ<span className="text-red-500 font-bold">*</span>
                  </label>
                  <input
                    type="number"
                    className="
              ...
              <div className="flex-col mt-6">
                ...
                <div className="mb-7 xl:w-96">
                  ...
                  {product.product_image && (
                    <div
                      className={`mt-2 flex-col w-[150px] relative h-[150px] overflow-hidden border ${
                        isDeleted && 'hidden'
                      }`}>
                      <button
                        className="text-red-500 z-50 top-5 left-2 absolute text-lg -mt-3"
                        onClick={() => {
                          setIsDeleted(true);
